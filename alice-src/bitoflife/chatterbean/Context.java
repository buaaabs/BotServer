...
public class Context implements Cloneable {
	...
	private Map<String, ContextPropertyChangeListener> listeners = new HashMap<String, ContextPropertyChangeListener>();
	...
	public Context clone() {
		...
		t.listeners = new HashMap<String,ContextPropertyChangeListener>(this.listeners);
		t.transformations = this.transformations;

...
//	InputStream ins = resourceAsStream(baseLoader(), name);
	...
	try
	{
		ins= new FileInputStream("D:/workspace/Java/MineBot/clj/"+file);
	}catch(Exception e){}
...
static public void load(String scriptbase, boolean failIfNotFound) throws IOException, ClassNotFoundException{
	...
	cljURL = new URL("file:///D:/workspace/Java/MineBot/clj/"+cljfile);
	if (cljURL!=null)
		System.out.println(cljURL.toExternalForm());
...
static void doInit() throws ClassNotFoundException, IOException{
	load("clojure/core");
//	load("D:\\workspace\\Java\\MineBot\\clojure-1.6.0-sources\\core")
	Var.pushThreadBindings(
			RT.mapUniqueKeys(CURRENT_NS, CURRENT_NS.deref(),
			       WARN_ON_REFLECTION, WARN_ON_REFLECTION.deref()
					,RT.UNCHECKED_MATH, RT.UNCHECKED_MATH.deref()));
